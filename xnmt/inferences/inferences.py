...
import xnmt.modules.output_processors
...
from xnmt import logger, reports
from xnmt.internal import events, utils
from xnmt.inferences import search_strategies
from xnmt.train import loss_calculators
from xnmt.structs import losses, sentences, batchers
...
class Inference(object):
  ...
  def generate_one(self, generator: 'networks.GeneratorModel', src: batchers.Batch) \
          -> List[sentences.ReadableSentence]:
    raise NotImplementedError("must be implemented by subclasses")

  def compute_losses_one(self, generator: 'networks.GeneratorModel', src: sentences.Sentence,
                         ref: sentences.Sentence) -> losses.FactoredLossExpr:
    raise NotImplementedError("must be implemented by subclasses")

  def perform_inference(self, generator: 'networks.GeneratorModel', src_file: str = None, trg_file: str = None, ref_file: str = None) \
          -> None:
    """
    Perform inference.
  ...
  def _generate_one_batch(self, generator: 'networks.GeneratorModel',
  ...
  def _generate_output(self, generator: 'networks.GeneratorModel', src_file: str,
  ...
  def _forced_decode_one_batch(self, generator: 'networks.GeneratorModel',
                               batcher: Optional[batchers.Batcher] = None,
                               src_batch: batchers.Batch = None,
  ...
  def _forced_decode(self, generator: 'networks.GeneratorModel', src_file: str,
  ...
  @staticmethod
  def _read_corpus(generator: 'networks.GeneratorModel', src_file: str, mode: str, ref_file: str) -> Tuple[List, List]:
...
class IndependentOutputInference(Inference, Serializable):
  ...
  def __init__(self,
               ...
               post_process: Union[None, str, xnmt.models.templates.OutputProcessor, Sequence[
                 xnmt.models.templates.OutputProcessor]] = None,
               mode: str = "onebest",
               batcher: batchers.InOrderBatcher = bare(batchers.InOrderBatcher, batch_size=1),
    ...
    self.post_processor = xnmt.models.templates.OutputProcessor.get_output_processor(post_process) or None
    self.loss_calculator = loss_calculator

  def generate_one(self,
                   generator: 'networks.GeneratorModel',
                   src: batchers.Batch) -> List[sentences.Sentence]:
...
class AutoRegressiveInference(Inference, Serializable):
  ...
  def __init__(self,
               ...
               max_src_len: Optional[int] = None,
               max_num_sents: Optional[int] = None,
               post_process: Union[str, xnmt.models.templates.OutputProcessor, Sequence[
                 xnmt.models.templates.OutputProcessor]] = [],
...
class CascadeInference(Inference, Serializable):
  ...
  def perform_inference(self, generator: 'networks.CascadeGenerator', src_file: str = None, trg_file: str = None, ref_file: str = None) \
          -> None:
