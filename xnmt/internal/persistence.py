"""
This module takes care of loading and saving YAML files. Both configuration files and saved networks are stored in the
...
* :class:`LoadSerialized`: can be used to load, modify, and re-assemble pretrained networks.
...
from xnmt.internal import tee, param_collections, utils
import xnmt
