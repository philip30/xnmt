...
class ExpGlobal(xnmt.Serializable):
  ...
  def __init__(self,
               ...
               param_init: xnmt.ParamInitializer = xnmt.bare(xnmt.param_initializers.GlorotInitializer),
               bias_init: xnmt.ParamInitializer = xnmt.bare(xnmt.param_initializers.ZeroInitializer),
